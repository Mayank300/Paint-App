...
canvas= Canvas(window, width=800, height=550, background='white') 
...
def display_pallete():
    ...
    id = canvas.create_rectangle((10,280,30,300),fill='peach puff')
    canvas.tag_bind(id, '<Button-1>', lambda x: show_color('peach puff'))
